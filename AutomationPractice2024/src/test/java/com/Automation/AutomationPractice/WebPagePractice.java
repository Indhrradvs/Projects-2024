...
public class WebPagePractice {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Helper.highLightElement(driver, fName);
		...
		Helper.highLightElement(driver, phone);
		...
		Helper.highLightElement(driver, cntry);
		...
		Helper.highLightElement(driver, clrSelect);
		...
		Helper.highLightElement(driver, newBrowser);
	...
	//	Thread.sleep(3000);
		...
		Helper.highLightElement(driver, alert);
	...
	//	Thread.sleep(3000);
		...
		Helper.highLightElement(driver, confirmBox);
